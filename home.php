...
<a href="logout.php" style="padding: 10px; background-color: skyblue; font-family:Arial, Helvetica, sans-serif; font-size:25px; text-decoration: none; float:right">Logout</a>
    ...
    <p id="Team">
     <div class="socialbox" >
       ...
       <div id="Harsha" style="margin-left: 34%;">
       <img class="circle" src="IMG_0634.JPG" alt="student">
           <h4>Sri Harsha K</h4>
           <a target="_blank" href="https://instagram.com/harshaaa.af?igshid=y7lvbhq8q0lp" ><i class="fab fa-instagram fa-2x" aria-hidden="true"></i></a>
           <a target="_blank" href="https://www.facebook.com/profile.php?id=100009059428700"><i class="fab fa-facebook-f fa-2x" aria-hidden="true"></i></a>
           <a target="_blank" href="https://twitter.com/bunny_sriharsh?s=08" target="_blank"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
           <a target="_blank" href="https://www.linkedin.com/in/sriharsha-k-49b0bb205/"><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>
           <a target="_blank" href="https://github.com/Harshaaaa-AI" target="_blank"><i class="fa fa-github fa-2x" aria-hidden="true"></i></a>
      </div>
      </div>
    </p>
